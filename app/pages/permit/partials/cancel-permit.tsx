...
export default function CancelPermit({ permit }: Readonly<{ permit: Permit }>) {
  ...
  const submit = async () => {
    try {
      await repository.cancel(permit.id!)
      setOpen(false)
      flashSuccess('Permit cancelled successfully')
      ...
      <DialogContent className="sm:max-w-[425px]">
        <form onSubmit={form.handleSubmit(submit)}>
          <DialogHeader>
            ...
            <DialogDescription>
              This action cannot be undone. Please confirm that you want to cancel this permit.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
